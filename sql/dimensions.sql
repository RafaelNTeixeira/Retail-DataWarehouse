...
INSERT INTO DimCustomer (
    ...
    age, gender, income_segment, customer_segment, first_order_date, last_order_date, customer_status
)
SELECT 
    Customer_ID,
    MAX(Name), -- If a customer changed names, we take the latest/max one
    MAX(Email),
    MAX(Phone),
    MAX(Address),
    MAX(City),
    ...
    MIN(Date), -- Earliest date they appeared
    MAX(Date), -- Latest date they appeared
